...
public class TestData {
    ...
    public static final VinylDiscDto DUMMY_DISC_DTO;
    ...
    static {
        DUMMY_STRING = "DUMMY";
        DUMMY_LONG = 999999;
        DUMMY_ARTISTS = List.of(new Artist("Artist", "Artist", Instrument.VOX));
        ...
        DUMMY_DISC_DTO = new VinylDiscDto(DUMMY_DISC, true);
